...
.bambu-card{background:#fff;border:1px solid #d9dfda;border-radius:12px;padding:18px 20px;margin-bottom:14px}
.bambu-card h3{margin:0 0 10px;color:#171918;font-size:16px}
.bambu-card p,.bambu-card li{color:#475569;font-size:13px;line-height:1.55}
.bambu-chip{display:inline-flex;margin:4px 5px 4px 0;padding:5px 9px;border-radius:999px;background:#ecf9ec;border:1px solid #b8dfba;color:#208d25;font-size:11px;font-weight:800}
.bambu-line{display:flex;justify-content:space-between;gap:14px;border-bottom:1px solid #edf1ee;padding:9px 0;font-size:13px}
.bambu-line span:first-child{color:#64748b}.bambu-line span:last-child{color:#171918;font-weight:800;text-align:right}
</style>
    """,
...
st.markdown(
    f'<div class="bambu-card" style="border-left:5px solid {BAMBU_GREEN}">'
...
<div class="bambu-card" style="background:{BAMBU_GREEN_BG};border-color:#b8dfba">
