"""Portal cliente Tiresias — Playbook SDR (en construcción)."""
import sys
...
st.set_page_config(page_title="Tiresias — Playbook SDR", layout="wide", page_icon="")

if not require_auth_client("tiresias"):
    st.stop()

render_client_nav("5_Tiresias_Playbook", "tiresias")
...
st.markdown(
    ...
    f'background:linear-gradient(135deg,#f8fafc,#eff6ff);padding:18px 28px;'
    f'border-radius:14px;border:1px solid #bfdbfe;margin-bottom:28px;'
...
st.markdown(
    ...
    'Estamos preparando el Playbook SDR con scripts de llamadas, '
    'objeciones frecuentes y guías de prospección personalizadas.<br><br>'
