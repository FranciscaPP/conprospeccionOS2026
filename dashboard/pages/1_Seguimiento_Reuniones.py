...
.summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:5px;margin:6px 0}.sum{border:1px solid var(--line);border-radius:8px;padding:5px 6px;min-width:0;background:#fff;text-align:left;cursor:pointer;color:var(--ink);font:inherit}.sum:hover{border-color:var(--gold);background:#fffdf0}.sum.final-state{border-color:var(--gold);background:var(--primary-soft)}.sum small{display:block;font-size:9px;color:var(--muted);font-weight:700;text-transform:uppercase;margin-bottom:3px;line-height:1.15}.sum.final-state small{color:#7A6400}.sum .chip{min-width:0;width:100%;padding:4px 5px;font-size:10.5px;justify-content:flex-start;line-height:1.15}.meta{display:grid;grid-template-columns:1fr 1fr;gap:4px;margin:0 0 6px}.meta div{border:0;border-top:1px solid var(--line);padding:4px 0 0;min-width:0}.meta small{display:block;color:var(--muted);font-size:9.5px;font-weight:700}.meta b,.meta select{display:block;margin-top:1px;font-size:12px;font-weight:600;max-width:100%;overflow:hidden;text-overflow:ellipsis}.meta select{border:0;background:transparent;outline:0}.alertline{grid-column:1/-1;border-top:1px solid #E8C164!important;background:#FFF8DC;border-radius:7px;padding:5px 7px!important}.alertline small{color:var(--orange)}.alertline.final{background:#FFF8DC;border-top-color:var(--gold)!important}.alertline.final small{color:#7A6400}
.tabs{display:grid;grid-template-columns:repeat(5,1fr);gap:3px;background:var(--muted-surface);border:1px solid var(--line);border-radius:9px;padding:3px;margin:5px 0 6px}.tabs button{border:1px solid transparent;background:transparent;border-radius:6px;padding:6px 3px;font-size:11px;font-weight:700;color:var(--muted);cursor:pointer;line-height:1.15}.tabs button.active{color:var(--ink);background:#fff;border-color:var(--gold);box-shadow:inset 0 -2px 0 var(--gold)}.panel{overflow:visible;padding:6px 10px 0;flex:0 0 auto}.grid{display:grid;grid-template-columns:1fr 1fr;gap:4px 6px}.field2 label{display:block;font-size:9px;color:var(--muted);font-weight:700;margin-bottom:1px}.field2 input,.field2 select,.field2 textarea{width:100%;border:1px solid var(--line);border-radius:7px;background:var(--surface);min-height:27px;padding:3px 7px;font-size:12px;outline:0}.field2 textarea{min-height:34px;resize:vertical}.wide{grid-column:1/-1}.context{background:var(--orange-bg);border:1px solid #F0D28D;border-radius:9px;padding:6px;margin-bottom:6px}.block-title{display:block;font-family:Saira,"IBM Plex Sans",sans-serif;font-size:12px;font-weight:700;margin-bottom:5px}.info-section{border-top:1px solid var(--line);padding-top:5px;margin-top:5px}.info-section:first-child{border-top:0;padding-top:0;margin-top:0}.section-title{font-family:Saira,"IBM Plex Sans",sans-serif;font-size:12px;font-weight:700;margin:0 0 4px;color:var(--ink)}.btn-row{display:flex;gap:8px;justify-content:flex-end;margin-top:7px}.save-bar{position:static;background:var(--surface);border-top:1px solid var(--line);padding:7px 0 0;margin:7px 0 0;z-index:4}.primary,.ghost{border-radius:9px;padding:7px 10px;font-size:12px;font-weight:700;cursor:pointer}.primary{border:0;background:var(--gold);color:var(--ink)}.primary:hover{background:var(--gold-hover)}.ghost{border:1px dashed var(--line-strong);background:white;color:var(--carbon)}
...
.layout.open .filters{grid-template-columns:1.4fr .7fr .7fr 1fr .7fr .55fr}.layout.open .kpis{grid-template-columns:repeat(4,1fr)}.layout.open .kpi{min-height:66px;padding:8px 10px}.layout.open .kpi b{font-size:21px}.layout.open table{table-layout:fixed;font-size:10.8px}.layout.open thead th,.layout.open tbody td{padding:5px 6px}.layout.open .pill{min-width:0;width:100%;padding:4px 5px;font-size:10.5px}.layout.open .quick{height:21px;font-size:10px}.layout.open .sub{font-size:9.5px;line-height:1.25}.layout.open thead th:nth-child(1),.layout.open tbody td:nth-child(1){width:78px}.layout.open thead th:nth-child(2),.layout.open tbody td:nth-child(2){width:80px}.layout.open thead th:nth-child(3),.layout.open tbody td:nth-child(3){display:none}.layout.open thead th:nth-child(4),.layout.open tbody td:nth-child(4){width:86px}.layout.open thead th:nth-child(5),.layout.open tbody td:nth-child(5){width:138px}.layout.open thead th:nth-child(6),.layout.open tbody td:nth-child(6){width:112px}.layout.open thead th:nth-child(7),.layout.open tbody td:nth-child(7){width:92px}.layout.open thead th:nth-child(8),.layout.open tbody td:nth-child(8){width:98px}.layout.open thead th:nth-child(9),.layout.open tbody td:nth-child(9){width:112px}.layout.open thead th:nth-child(10),.layout.open tbody td:nth-child(10){width:52px}
