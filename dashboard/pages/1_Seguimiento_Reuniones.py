  ...
  <div class="layout" id="layout">
    <main class="main">
      <section class="card">
        ...
        <div class="quick-dates"><span class="qd-label">Rápido:</span><button onclick="setToday()">Hoy</button><button onclick="setThisWeek()">Esta semana</button><button onclick="resetDateRange()">Este mes</button></div>
