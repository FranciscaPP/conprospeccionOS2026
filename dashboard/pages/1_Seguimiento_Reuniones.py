...
.layout{display:grid;grid-template-columns:1fr;gap:12px;align-items:start}.layout.open{grid-template-columns:minmax(0,1fr) minmax(500px,31vw)}.layout.open .main{min-width:0;overflow:hidden}
...
.table-wrap{overflow:visible;border-top:1px solid var(--line)}table{width:100%;border-collapse:separate;border-spacing:0;font-size:12px;table-layout:auto}thead th{position:sticky;top:0;z-index:3;background:var(--muted-surface);border-bottom:1px solid var(--line);text-align:left;color:#9A9A98;font-size:11px;font-weight:700;padding:6px 10px;white-space:nowrap;text-transform:uppercase;letter-spacing:.03em}.sort{border:0;background:transparent;color:inherit;font-weight:700;cursor:pointer;padding:0}.quick{margin-top:4px;width:100%;height:23px;border:1px solid var(--line);border-radius:6px;background:#fff;font-size:11px;color:var(--ink)}
...
.action{border:1px solid var(--line);background:#fff;color:var(--carbon);font-size:12px;font-weight:700;cursor:pointer;border-radius:7px;padding:5px 9px}.action:hover{background:var(--gold);border-color:var(--gold);color:var(--ink)}.drawer{padding:0;position:sticky;top:10px;display:flex;flex-direction:column;overflow:visible}.drawer.hidden{display:none}.drawer-fixed{flex:0 0 auto;padding:11px 14px 0;background:var(--surface);border-bottom:1px solid var(--line)}.drawer-top{display:flex;align-items:flex-start;justify-content:space-between;gap:10px;margin-bottom:7px}.drawer h2{font-family:Saira,"IBM Plex Sans",sans-serif;font-size:15px;margin:0;line-height:1.2}.drawer-title-sub{font-size:11px;color:var(--muted);margin-top:2px}.close{border:0;background:transparent;color:var(--muted);font-size:20px;cursor:pointer}
.summary{display:grid;grid-template-columns:1.18fr 1fr 1fr 1fr;gap:6px;margin:7px 0}.sum{border:1px solid var(--line);border-radius:8px;padding:6px 7px;min-width:0;background:#fff;text-align:left;cursor:pointer;color:var(--ink);font:inherit}.sum:hover{border-color:var(--gold);background:#fffdf0}.sum.final-state{border-color:var(--gold);background:var(--primary-soft)}.sum small{display:block;font-size:9.5px;color:var(--muted);font-weight:700;text-transform:uppercase;margin-bottom:3px}.sum.final-state small{color:#7A6400}.sum .chip{min-width:0;width:100%;padding:4px 6px;font-size:11px;justify-content:flex-start}.meta{display:grid;grid-template-columns:1fr 1fr;gap:5px;margin:0 0 8px}.meta div{border:0;border-top:1px solid var(--line);padding:5px 0 0;min-width:0}.meta small{display:block;color:var(--muted);font-size:10px;font-weight:700}.meta b,.meta select{display:block;margin-top:2px;font-size:12px;font-weight:600;max-width:100%;overflow:hidden;text-overflow:ellipsis}.meta select{border:0;background:transparent;outline:0}.alertline{grid-column:1/-1;border-top:1px solid #E8C164!important;background:#FFF8DC;border-radius:7px;padding:6px 8px!important}.alertline small{color:var(--orange)}.alertline.final{background:#FFF8DC;border-top-color:var(--gold)!important}.alertline.final small{color:#7A6400}
.tabs{display:grid;grid-template-columns:repeat(5,1fr);gap:3px;background:var(--muted-surface);border:1px solid var(--line);border-radius:9px;padding:3px;margin:6px 0 7px}.tabs button{border:1px solid transparent;background:transparent;border-radius:6px;padding:7px 4px;font-size:11.5px;font-weight:700;color:var(--muted);cursor:pointer}.tabs button.active{color:var(--ink);background:#fff;border-color:var(--gold);box-shadow:inset 0 -2px 0 var(--gold)}.panel{overflow:visible;padding:7px 10px 0;flex:0 0 auto}.grid{display:grid;grid-template-columns:1fr 1fr;gap:5px}.field2 label{display:block;font-size:9.5px;color:var(--muted);font-weight:700;margin-bottom:1px}.field2 input,.field2 select,.field2 textarea{width:100%;border:1px solid var(--line);border-radius:7px;background:var(--surface);min-height:28px;padding:4px 7px;font-size:12px;outline:0}.field2 textarea{min-height:40px;resize:vertical}.wide{grid-column:1/-1}.context{background:var(--orange-bg);border:1px solid #F0D28D;border-radius:9px;padding:7px;margin-bottom:7px}.block-title{display:block;font-family:Saira,"IBM Plex Sans",sans-serif;font-size:12px;font-weight:700;margin-bottom:5px}.info-section{border-top:1px solid var(--line);padding-top:6px;margin-top:6px}.info-section:first-child{border-top:0;padding-top:0;margin-top:0}.section-title{font-family:Saira,"IBM Plex Sans",sans-serif;font-size:12px;font-weight:700;margin:0 0 5px;color:var(--ink)}.btn-row{display:flex;gap:8px;justify-content:flex-end;margin-top:8px}.save-bar{position:sticky;bottom:0;background:linear-gradient(to top,var(--surface) 75%,rgba(255,255,255,.78));border-top:1px solid var(--line);padding:8px 0;margin:8px -10px 0;z-index:4}.primary,.ghost{border-radius:9px;padding:7px 10px;font-size:12px;font-weight:700;cursor:pointer}.primary{border:0;background:var(--gold);color:var(--ink)}.primary:hover{background:var(--gold-hover)}.ghost{border:1px dashed var(--line-strong);background:white;color:var(--carbon)}
.evidence{display:grid;grid-template-columns:1fr 1fr;gap:6px}.evi{border:1px solid var(--line);border-radius:8px;padding:7px;background:white;font-size:12px;font-weight:600}.evi-top{display:flex;align-items:center;justify-content:space-between;gap:6px}.vis-toggle{border:1px solid var(--line);background:#fff;border-radius:999px;padding:3px 7px;font-size:10.5px;color:var(--muted);cursor:pointer;white-space:nowrap}.vis-toggle.on{border-color:#BFE6CC;background:var(--green-bg);color:var(--green)}.evi small,.evi p{display:block;color:var(--muted);font-weight:500;margin:3px 0 0;font-size:10.5px;line-height:1.32}.evi a{color:var(--carbon);text-decoration:underline;text-decoration-color:var(--gold);text-underline-offset:3px}.read{border:1px solid var(--line);border-radius:9px;padding:7px;background:white}.read p{margin:4px 0;font-size:12px}.history,.timeline{border-left:2px solid var(--line);padding-left:12px;margin-left:6px}.hist,.tl{position:relative;margin-bottom:10px}.hist small,.tl small{color:var(--muted)}.hist b,.tl b{display:block;font-size:12.5px;margin:2px 0}.hist:before,.tl:before{content:"";position:absolute;left:-17px;top:3px;width:8px;height:8px;border-radius:99px;background:var(--gold)}.event-meta{font-size:11px;color:var(--muted);margin-top:2px}.event-badge{display:inline-flex;border-radius:999px;padding:2px 6px;font-size:10.5px;font-weight:700;background:var(--gray-bg);color:var(--gray);margin-left:4px}.event-badge.manual{background:var(--orange-bg);color:var(--orange)}.event-badge.client{background:var(--blue-bg);color:var(--blue)}.manual-form{border:1px solid var(--line);border-radius:9px;background:#fff;padding:8px;margin-bottom:10px}.manual-actions{display:flex;gap:6px;margin-top:5px}.mini{border:1px solid var(--line);background:#fff;border-radius:6px;padding:4px 7px;font-size:11px;cursor:pointer;color:var(--carbon)}.mini:hover{border-color:var(--gold);background:#fffdf0}.save-note{position:fixed;right:24px;bottom:18px;background:var(--carbon);color:white;border-radius:8px;padding:10px 12px;font-size:12px;font-weight:600;box-shadow:0 8px 24px rgba(26,26,26,.22);z-index:20}
.layout.open table{table-layout:fixed;font-size:11px}.layout.open thead th,.layout.open tbody td{padding:5px 6px}.layout.open .pill{min-width:74px;padding:4px 5px;font-size:10.5px}.layout.open .quick{height:21px;font-size:10px}.layout.open .sub{font-size:9.5px;line-height:1.25}.layout.open thead th:nth-child(3),.layout.open tbody td:nth-child(3){display:none}.layout.open thead th:nth-child(4),.layout.open tbody td:nth-child(4){width:92px}.layout.open thead th:nth-child(5),.layout.open tbody td:nth-child(5){width:150px}.layout.open thead th:nth-child(10),.layout.open tbody td:nth-child(10){width:54px}
...
function renderPanel(){if(!panelOpen)return;const m=current();document.getElementById("detailTitle").textContent=m.company||m.contact||"Detalle de reunión";document.getElementById("detailSubtitle").textContent=`${m.contact||"Sin contacto"} - ${m.client||"Sin cliente"}`;const states=[["Estado Final",finalDisplay(m),"final-state","Estado Final"],["Etapa Agenda",m.status,"","Información"],["Evaluación CP",m.cp,"","Evaluación CP"],["Evaluación Cliente",m.clientVal,"","Evaluación Cliente"]];document.getElementById("summary").innerHTML=states.map(i=>`<button class="sum ${i[2]}" onclick="tab='${i[3]}';renderPanel()" title="Ver detalle de ${esc(i[0])}"><small>${i[0]}</small><span class="chip ${tone(i[1])}" title="${esc(i[1])}">${esc(i[1])}</span></button>`).join("");const alert=operationalAlert(m);const fAlert=finalAlert(m);document.getElementById("meta").innerHTML=`<div><small>Cliente</small><b>${esc(m.client)}</b></div><div><small>Fecha y hora</small><b>${esc(m.date)} ${esc(m.time)}</b></div><div><small>SDR asignada</small><select onchange="setField(${m.id},'sdr',this.value)">${opt([...new Set(meetings.map(x=>x.sdr).filter(Boolean))],m.sdr)}</select></div><div><small>Estado del Caso</small><select onchange="setField(${m.id},'caseStatus',this.value)">${opt(caseStatusOptions,m.caseStatus)}</select></div>${fAlert?`<div class="alertline final"><small>Alerta final</small><b>${esc(fAlert)}</b></div>`:""}${alert&&alert!=="Sin alertas operativas"?`<div class="alertline"><small>Alerta operativa</small><b>${esc(alert)}</b></div>`:""}`;const tabs=["Información","Evaluación CP","Evaluación Cliente","Estado Final","Historial"];document.getElementById("tabs").innerHTML=tabs.map(t=>`<button class="${tab===t?"active":""}" onclick="tab='${t}';renderPanel()">${t}</button>`).join("");let html="";if(tab==="Información")html=infoTab(m);if(tab==="Evaluación CP")html=cpTab(m);if(tab==="Evaluación Cliente")html=clientTab(m);if(tab==="Estado Final")html=finalTab(m);if(tab==="Historial")html=historyTab(m);document.getElementById("panel").innerHTML=html}
...
function cpTab(m){m.evidence=m.evidence||[];return `<div class="grid"><div class="field2"><label>Evaluación CP</label><select onchange="setField(${m.id},'cp',this.value)">${opt(cps,m.cp)}</select></div><div class="field2"><label>ICP</label><select onchange="setField(${m.id},'icp',this.value)">${opt(["No evaluado","Cumple","No cumple"],m.icp)}</select></div><div class="wide"><span class="block-title">BANT</span><div class="evidence">${Object.keys(m.bant).map(k=>`<label class="evi"><input type="checkbox" ${m.bant[k]?"checked":""} onchange="const m=current();const old={...m.bant};m.bant['${k}']=this.checked;addHistory(m,'BANT',old,{...m.bant});persist();saveMeeting(m,'BANT',true);render()"> ${k}<small>${m.bant[k]?"Sí":"No"}</small></label>`).join("")}</div></div>${field("just","Justificación CP visible al cliente","textarea")}${field("notes","Nota interna CP","textarea")}</div><span class="block-title" style="margin-top:10px">Evidencias y archivos</span><div class="evidence">${m.evidence.map(evidenceCard).join("")||"<span class='sub'>Sin evidencia sincronizada todavía.</span>"}<button class="ghost" onclick="addEvidence('Archivo')">Subir archivo</button><button class="ghost" onclick="addEvidence('Enlace')">Pegar enlace</button><button class="ghost" onclick="addEvidence('Comentario')">Agregar comentario</button></div>${saveBar("Evaluación CP","Guardar Evaluación CP")}`}
