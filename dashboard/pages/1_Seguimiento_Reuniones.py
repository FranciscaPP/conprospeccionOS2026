...
@media(max-width:1200px){.layout.open{grid-template-columns:minmax(0,1fr) 420px}.detail-band{grid-template-columns:minmax(155px,1fr) 1fr 1fr;padding-right:28px}.band-main{grid-row:span 2}.summary{grid-template-columns:1fr 1fr}.grid{grid-template-columns:1fr}.tabs button{font-size:11px;padding:7px 3px}}
