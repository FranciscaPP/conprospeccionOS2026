...
.action{border:1px solid var(--line);background:#fff;color:var(--carbon);font-size:12px;font-weight:700;cursor:pointer;border-radius:7px;padding:5px 9px}.action:hover{background:var(--gold);border-color:var(--gold);color:var(--ink)}.drawer{padding:0;position:sticky;top:10px;display:flex;flex-direction:column;overflow:visible}.drawer.hidden{display:none}.drawer-fixed{flex:0 0 auto;padding:18px 20px 0;background:var(--surface);border-bottom:1px solid var(--line);position:sticky;top:0;z-index:5}.close{position:absolute;right:10px;top:6px;border:0;background:transparent;color:var(--ink);font-size:22px;cursor:pointer;z-index:6}.detail-band{display:flex;flex-wrap:wrap;gap:16px 24px;align-items:center;border:1px solid #FFE6A3;background:#FFF7D0;border-radius:8px;padding:16px;margin-bottom:18px}.band-main{display:flex;align-items:center;gap:14px;min-width:220px;flex:1.4 1 220px;border-right:1px solid #F0D28D;padding-right:20px}.band-icon{width:44px;height:44px;border-radius:50%;display:grid;place-items:center;background:#FFD7001A;color:#B88600;font-size:22px;font-weight:800;flex:0 0 auto}.band-title{min-width:0}.band-title b{display:block;font-family:Saira,"IBM Plex Sans",sans-serif;font-size:16px;line-height:1.12;color:var(--ink);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:180px}.band-title span{display:block;margin-top:4px;color:var(--muted);font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;max-width:180px}.band-item{display:grid;grid-template-columns:auto 1fr auto;gap:7px;align-items:center;min-width:112px;flex:1 1 112px}.band-ico{font-size:15px;color:var(--carbon)}.band-copy small{display:block;color:var(--muted);font-size:11px;line-height:1.05}.band-copy b,.band-copy select{display:block;margin-top:4px;color:var(--ink);font-size:13px;font-weight:700;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.band-copy select{border:0;background:transparent;outline:0;padding:0}.band-caret{color:#B88600;font-weight:800;font-size:13px}.alert-wrap{margin:0 0 7px}
