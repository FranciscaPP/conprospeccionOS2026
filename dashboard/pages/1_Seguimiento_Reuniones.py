...
.action{border:1px solid var(--line);background:#fff;color:var(--carbon);font-size:12px;font-weight:700;cursor:pointer;border-radius:7px;padding:5px 9px}.action:hover{background:var(--gold);border-color:var(--gold);color:var(--ink)}.drawer{padding:0;position:sticky;top:10px;display:flex;flex-direction:column;overflow:visible}.drawer.hidden{display:none}.drawer-fixed{flex:0 0 auto;padding:14px 16px 0;background:var(--surface);border-bottom:1px solid var(--line);position:relative}.close{position:absolute;right:12px;top:10px;border:0;background:transparent;color:var(--muted);font-size:20px;cursor:pointer;z-index:2}.detail-band{display:grid;grid-template-columns:minmax(210px,1.25fr) repeat(4,minmax(120px,1fr));gap:16px;align-items:center;border:1px solid #FFE6A3;background:#FFF7D0;border-radius:8px;padding:16px 36px 16px 16px;margin-bottom:14px}.band-main{display:flex;align-items:center;gap:12px;min-width:0;border-right:1px solid #F0D28D;padding-right:16px}.band-icon{width:48px;height:48px;border-radius:50%;display:grid;place-items:center;background:#FFD7001A;color:#B88600;font-size:24px;font-weight:800}.band-title{min-width:0}.band-title b{display:block;font-family:Saira,"IBM Plex Sans",sans-serif;font-size:17px;line-height:1.15;color:var(--ink);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.band-title span{display:block;margin-top:4px;color:var(--muted);font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.band-item{display:grid;grid-template-columns:auto 1fr auto;gap:7px;align-items:center;min-width:0}.band-ico{font-size:15px;color:var(--carbon)}.band-copy small{display:block;color:var(--muted);font-size:12px;line-height:1.1}.band-copy b,.band-copy select{display:block;margin-top:5px;color:var(--ink);font-size:14px;font-weight:700;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.band-copy select{border:0;background:transparent;outline:0;padding:0}.band-caret{color:#B88600;font-weight:800}.alert-wrap{margin:0 0 6px}
.summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin:0 0 14px}.sum{border:1px solid var(--line);border-radius:8px;padding:9px 10px;min-width:0;background:#fff;text-align:left;cursor:pointer;color:var(--ink);font:inherit}.sum:hover{border-color:var(--gold);background:#fffdf0}.sum.final-state{border-color:var(--gold);background:var(--primary-soft)}.sum small{display:block;font-size:11px;color:var(--muted);font-weight:700;text-transform:uppercase;margin-bottom:7px;line-height:1.15}.sum.final-state small{color:#7A6400}.sum .chip{min-width:0;width:100%;padding:7px 8px;font-size:12px;justify-content:flex-start;line-height:1.15}.meta{display:block}.alertline{border:1px solid #E8C164!important;background:#FFF8DC;border-radius:7px;padding:5px 7px!important;margin-bottom:6px}.alertline small{color:var(--orange)}.alertline.final{background:#FFF8DC;border-color:var(--gold)!important}.alertline.final small{color:#7A6400}
...
@media(max-width:1200px){.layout.open{grid-template-columns:minmax(0,1fr) 420px}.detail-band{grid-template-columns:1fr 1fr;padding-right:32px}.band-main{grid-column:1/-1;border-right:0;border-bottom:1px solid #F0D28D;padding:0 0 12px}.summary{grid-template-columns:1fr 1fr}.grid{grid-template-columns:1fr}.tabs button{font-size:11px;padding:7px 3px}}
