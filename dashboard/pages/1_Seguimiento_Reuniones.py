...
.kpis{display:grid;grid-template-columns:repeat(5,1fr);overflow:hidden}.kpi{min-height:74px;padding:10px 12px;border-right:1px solid var(--line);display:flex;gap:10px;align-items:center;cursor:pointer}.kpi:last-child{border-right:0}.kpi.active{box-shadow:inset 0 -3px 0 var(--gold);background:#fffdf0}
...
.table-card{overflow:visible}.table-head{display:flex;justify-content:space-between;align-items:end;padding:11px 14px 7px}.table-head h2{font-family:Saira,"IBM Plex Sans",sans-serif;font-size:14px;margin:0}.table-head p{font-size:11px;color:var(--muted);margin:3px 0 0}
.table-wrap{overflow:visible;max-height:none;border-top:1px solid var(--line);width:100%}table{width:100%;max-width:100%;border-collapse:separate;border-spacing:0;font-size:12px;table-layout:fixed}thead th{position:sticky;top:0;z-index:3;background:var(--muted-surface);border-bottom:1px solid var(--line);text-align:left;color:#9A9A98;font-size:11px;font-weight:700;padding:6px 8px;white-space:nowrap;text-transform:uppercase;letter-spacing:.03em;overflow:hidden;text-overflow:ellipsis}.sort{border:0;background:transparent;color:inherit;font-weight:700;cursor:pointer;padding:0;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.quick{width:100%;height:22px;border:0;border-radius:0;background:transparent;font-size:11px;color:#8A8A86;font-weight:700;text-transform:uppercase;letter-spacing:.03em;outline:0;cursor:pointer;padding:0;max-width:100%;overflow:hidden;text-overflow:ellipsis}.quick.active{color:var(--ink);background:#fff;border:1px solid var(--line);border-radius:6px;padding:0 5px;text-transform:none;letter-spacing:0}
tbody td{border-bottom:1px solid var(--line);padding:6px 8px;vertical-align:middle;white-space:nowrap;height:38px;overflow:hidden;text-overflow:ellipsis}tbody tr{cursor:pointer}tbody tr:hover{background:#FFF9D6}tbody tr.selected{box-shadow:inset 3px 0 0 var(--gold)}.sub{display:block;color:var(--muted);font-size:10.5px;margin-top:2px;line-height:1.2;overflow:hidden;text-overflow:ellipsis}.company{font-weight:600}.avatar-sm{width:22px;height:22px;border-radius:50%;display:inline-grid;place-items:center;margin-right:8px;background:var(--gray-bg);color:var(--gray);font-size:10px;font-weight:700}.avatar-sm.gbs{background:var(--purple-bg);color:var(--purple)}.avatar-sm.clickie{background:#FFF1B8;color:#A66A00}.avatar-sm.bambutech{background:var(--green-bg);color:var(--green)}
...
.layout.open .filters{grid-template-columns:1.4fr .7fr .7fr 1fr .7fr .55fr}.layout.open .kpis{grid-template-columns:repeat(3,1fr)}.layout.open .kpi{min-height:66px;padding:8px 10px}.layout.open .kpi b{font-size:21px}.layout.open table{table-layout:fixed;font-size:10.6px}.layout.open thead th,.layout.open tbody td{padding:5px 5px}.layout.open .pill{min-width:0;width:100%;padding:4px 5px;font-size:10.2px}.layout.open .quick{height:20px;font-size:10px}.layout.open .sub{font-size:9.3px;line-height:1.2}.layout.open thead th:nth-child(1),.layout.open tbody td:nth-child(1){width:74px}.layout.open thead th:nth-child(2),.layout.open tbody td:nth-child(2){width:72px}.layout.open thead th:nth-child(3),.layout.open tbody td:nth-child(3){width:104px}.layout.open thead th:nth-child(4),.layout.open tbody td:nth-child(4){width:74px}.layout.open thead th:nth-child(5),.layout.open tbody td:nth-child(5){width:122px}.layout.open thead th:nth-child(6),.layout.open tbody td:nth-child(6){width:103px}.layout.open thead th:nth-child(7),.layout.open tbody td:nth-child(7){width:82px}.layout.open thead th:nth-child(8),.layout.open tbody td:nth-child(8){width:90px}.layout.open thead th:nth-child(9),.layout.open tbody td:nth-child(9){width:100px}.layout.open thead th:nth-child(10),.layout.open tbody td:nth-child(10){width:62px}
...
thead th,.quick,.quick.active,.sort{font-family:Saira,"IBM Plex Sans",sans-serif;font-weight:600;font-size:11px;letter-spacing:.05em;text-transform:uppercase;color:#9A9A98}
.quick{width:auto;max-width:100%}
thead th{position:sticky;top:0;z-index:6;background:var(--muted-surface)}
.kpis{grid-template-columns:repeat(5,1fr)}
tbody tr.selected{box-shadow:inset 4px 0 0 var(--gold)}
.layout.open tbody tr.selected{background:#FFF7D0;box-shadow:inset 4px 0 0 var(--gold),inset 0 0 0 1px #F0D28D}
.layout.open tbody tr.selected:hover{background:#FFF1B8}
.quick-dates{display:flex;align-items:center;gap:7px;padding:0 14px 12px;background:#FAFAF8;flex-wrap:wrap}
.quick-dates .qd-label{font-size:10px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.04em}
.quick-dates button{border:1px solid #D8D8D5;background:#fff;border-radius:999px;padding:5px 12px;font-size:11px;font-weight:700;color:var(--carbon);cursor:pointer}
.quick-dates button:hover{border-color:var(--gold);background:#fffdf0}
.date-range input{min-width:0}
.table-card th:nth-child(1),.table-card td:nth-child(1){width:7%}
.table-card th:nth-child(2),.table-card td:nth-child(2){width:7%}
.table-card th:nth-child(3),.table-card td:nth-child(3){width:14%}
.table-card th:nth-child(4),.table-card td:nth-child(4){width:11%}
.table-card th:nth-child(5),.table-card td:nth-child(5){width:15%}
.table-card th:nth-child(6),.table-card td:nth-child(6){width:10%}
.table-card th:nth-child(7),.table-card td:nth-child(7){width:9%}
.table-card th:nth-child(8),.table-card td:nth-child(8){width:10%}
.table-card th:nth-child(9),.table-card td:nth-child(9){width:11%}
.table-card th:nth-child(10),.table-card td:nth-child(10){width:6%;text-align:center}
.table-card th:nth-child(10){text-align:center}
.sdr-cell{display:inline-flex;align-items:center;gap:3px;max-width:100%}
.sdr-select{border:0;background:transparent;font:inherit;color:var(--ink);font-weight:600;cursor:pointer;max-width:100%;outline:0;padding:2px 0;-webkit-appearance:none;appearance:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.sdr-select:hover{color:var(--blue)}
.sdr-caret{color:#B88600;font-weight:800;font-size:11px;pointer-events:none}
.band-sdr{display:flex;align-items:center;gap:4px}
.link-field{display:flex;align-items:center;gap:6px}
.link-field input{flex:1;min-width:0}
.open-link{color:var(--blue);font-weight:700;text-decoration:none;white-space:nowrap;font-size:11px}
.open-link:hover{text-decoration:underline}
.layout.open .filters{grid-template-columns:1.3fr .6fr .6fr 1.35fr .7fr .55fr}
.layout.open .date-range input{font-size:10px}
.layout.open thead th{font-size:9.4px;line-height:1.12;white-space:normal;vertical-align:bottom}
.layout.open .quick{font-size:9.4px;height:auto;min-height:20px;white-space:normal;line-height:1.12}
.layout.open .sdr-select{font-size:9.6px}
/* === Diseño de sistema: chips de estado, limpiar, historial === */
.qd-status{display:inline-flex;gap:7px;flex-wrap:wrap;align-items:center}
.qd-chip{display:inline-flex;align-items:center;gap:7px;border:1px solid #D8D8D5;background:#fff;border-radius:999px;padding:5px 12px;font:600 11px "IBM Plex Sans",sans-serif;color:var(--carbon);cursor:pointer}
.qd-chip:before{content:"";width:8px;height:8px;border-radius:99px;background:var(--dot,#9A9A98)}
.qd-chip.orange{--dot:#92610A}.qd-chip.blue{--dot:#2563EB}.qd-chip.green{--dot:#15803D}.qd-chip.red{--dot:#C0392B}
.qd-chip.on{border-color:var(--dot);background:#FFFBEF;color:var(--ink)}
.qd-clear{margin-left:auto;border:1px solid #D8D8D5;background:#fff;border-radius:999px;padding:5px 12px;font:600 11px "IBM Plex Sans",sans-serif;color:var(--carbon);cursor:pointer}
.qd-clear:hover{border-color:var(--gold);background:#fffdf0}
.history{font-family:"IBM Plex Sans",sans-serif;font-size:12px;color:var(--carbon)}
.history .hist small{font-family:"IBM Plex Mono",monospace;font-size:10.5px;color:var(--muted)}
.history .hist b{font-family:"IBM Plex Sans",sans-serif;font-size:12.5px;font-weight:600;color:var(--ink);margin:2px 0}
.row-actions{display:inline-flex;align-items:center;gap:4px}
.act-eye,.act-kebab{border:1px solid var(--line);background:#fff;border-radius:7px;width:30px;height:28px;cursor:pointer;color:var(--carbon);display:grid;place-items:center;font-size:15px;line-height:1}
.act-eye:hover,.act-kebab:hover{border-color:var(--gold);background:#fffdf0;color:var(--ink)}
.row-menu{position:absolute;z-index:60;background:#fff;border:1px solid var(--line);border-radius:9px;box-shadow:0 12px 32px rgba(26,26,26,.18);padding:5px;min-width:184px;display:flex;flex-direction:column}
.row-menu button{display:flex;align-items:center;gap:8px;border:0;background:transparent;text-align:left;padding:8px 10px;border-radius:7px;font:600 12px "IBM Plex Sans",sans-serif;color:var(--ink);cursor:pointer}
.row-menu button:hover{background:var(--muted-surface)}
  ...
  <div class="layout" id="layout">
    <main class="main">
      <section class="card">
        ...
        <div class="quick-dates"><span class="qd-label">Rápido:</span><button onclick="setToday()">Hoy</button><button onclick="setThisWeek()">Esta semana</button><button onclick="resetDateRange()">Este mes</button><span id="quickStatus" class="qd-status"></span><button class="qd-clear" onclick="clearAll()">↻ Limpiar filtros</button></div>
      ...
      <section class="card progress">
        <div class="section-head"><b>Avance por cliente <span class="sub" style="display:inline">reuniones con estado final válida / meta contractual</span></b><small onclick="filters.client='Todos';render()" style="cursor:pointer">Ver todos los clientes</small></div>
        <div class="client-row" id="clientProgress"></div>
      </section>
      <section class="card kpis" id="kpis"></section>
      <section class="card table-card">
        <div class="table-head"><div><h2>Seguimiento de reuniones</h2><p>Filtros, KPIs, avance y tabla usan el mismo estado central.</p></div><div class="th-actions"><button class="ghost" onclick="refreshData()" title="Traer los últimos datos de Supabase">↻ Actualizar</button><button class="primary newmeet-btn" id="newMeetBtn" onclick="toggleNewMeeting()">+ Nueva reunión</button></div></div>
...
function scheduleComponentHeight(){requestAnimationFrame(()=>requestAnimationFrame(setComponentHeight))}
...
const EYE_SVG='<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>';
const TRASH_SVG='<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6"/></svg>';
let meetings=[
...
function monthYearRange(year,month){const allY=year==="Todos"||!year;const allM=month==="Todos"||!month;if(allY)return {dateFrom:"",dateTo:""};if(allM)return {dateFrom:iso(new Date(Number(year),0,1)),dateTo:iso(new Date(Number(year),11,31))};return rangeForMonth(year,month)}
...
function setFilter(k,v){filters[k]=v;if(k==="month"||k==="year"){Object.assign(filters,monthYearRange(filters.year,filters.month))}syncDependent(k);render()}
...
function resetDateRange(){filters.month=String(new Date().getMonth()+1);filters.year=String(new Date().getFullYear());Object.assign(filters,defaultRange());render()}
function setToday(){const t=iso(new Date());filters.dateFrom=t;filters.dateTo=t;render()}
function setThisWeek(){const now=new Date();const day=(now.getDay()+6)%7;const mon=new Date(now);mon.setDate(now.getDate()-day);const sun=new Date(mon);sun.setDate(mon.getDate()+6);filters.dateFrom=iso(mon);filters.dateTo=iso(sun);render()}
function clearFilter(k){if(k==="date"){filters.month=String(new Date().getMonth()+1);filters.year=String(new Date().getFullYear());Object.assign(filters,defaultRange())}else{filters[k]=k==="q"?"":"Todos"}render()}
function clearAll(){filters=defaultFilters();render()}
function applyFilters(options={}){const ignore=options.ignore||[];return meetings.filter(m=>{const hay=`${m.company} ${m.contact} ${m.role} ${m.email} ${m.phone}`.toLowerCase();const md=parseDate(m.date);if(!ignore.includes("q")&&filters.q&&!hay.includes(filters.q.toLowerCase()))return false;if(!ignore.includes("date")&&filters.dateFrom&&md<filters.dateFrom)return false;if(!ignore.includes("date")&&filters.dateTo&&md>filters.dateTo)return false;if(!ignore.includes("date")&&filters.year==="Todos"&&!filters.dateFrom&&!filters.dateTo&&filters.month&&filters.month!=="Todos"&&md&&md.slice(5,7)!==String(filters.month).padStart(2,"0"))return false;if(!ignore.includes("client")&&filters.client!=="Todos"&&m.client!==filters.client)return false;if(!ignore.includes("sdr")&&filters.sdr!=="Todos"&&m.sdr!==filters.sdr)return false;if(!ignore.includes("status")&&filters.status!=="Todos"&&m.status!==filters.status)return false;if(!ignore.includes("cp")&&filters.cp!=="Todos"&&m.cp!==filters.cp)return false;if(!ignore.includes("clientVal")&&filters.clientVal!=="Todos"&&m.clientVal!==filters.clientVal)return false;if(!ignore.includes("final")&&filters.final!=="Todos"&&finalStatus(m)!==filters.final)return false;if(!ignore.includes("country")&&filters.country!=="Todos"&&m.country!==filters.country)return false;if(!ignore.includes("caseStatus")&&filters.caseStatus!=="Todos"&&m.caseStatus!==filters.caseStatus)return false;return true})}
...
function renderFilters(rows){const opts=optionSets(applyFilters({ignore:["sdr","country","status","cp","clientVal","final","caseStatus"]}));document.getElementById("q").value=filters.q;document.getElementById("fMonth").innerHTML=optPairs([["Todos","Todos"],...monthOptions()],filters.month);document.getElementById("fYear").innerHTML=opt(["Todos",...yearOptions()],filters.year);document.getElementById("fClient").innerHTML=opt(["Todos",...optionSets(meetings).client],filters.client);document.getElementById("fDateFrom").value=filters.dateFrom;document.getElementById("fDateTo").value=filters.dateTo;document.getElementById("fSdr").innerHTML=opt(["Todos",...opts.sdr],filters.sdr);document.getElementById("fStatus").innerHTML=opt(["Todos",...opts.status],filters.status);document.getElementById("fCp").innerHTML=opt(["Todos",...opts.cp],filters.cp);document.getElementById("fClientVal").innerHTML=opt(["Todos",...opts.clientVal],filters.clientVal);document.getElementById("fFinal").innerHTML=opt(["Todos",...opts.final],filters.final);document.getElementById("fCountry").innerHTML=opt(["Todos",...opts.country],filters.country);document.getElementById("fCaseStatus").innerHTML=opt(["Todos",...opts.caseStatus],filters.caseStatus);document.getElementById("extraFilters").classList.toggle("open",more);document.getElementById("moreBtn").textContent=`Más filtros${activeFilterCount()?` (${activeFilterCount()})`:""}`;renderActiveFilters()}
function renderActiveFilters(){const d=defaultRange();const labels={q:"Buscar",client:"Cliente",sdr:"SDR",status:"Etapa",cp:"CP",clientVal:"Cliente",final:"Final",country:"País",caseStatus:"Caso"};const chips=[];Object.keys(labels).forEach(k=>{if((k==="q"&&filters.q)||(k!=="q"&&filters[k]&&filters[k]!=="Todos"))chips.push(`<span class="filter-chip">${labels[k]}: ${esc(filters[k])}<button onclick="clearFilter('${k}')">x</button></span>`)});if(filters.dateFrom!==d.dateFrom||filters.dateTo!==d.dateTo){const ftxt=(!filters.dateFrom&&!filters.dateTo)?"todas":`${filters.dateFrom} / ${filters.dateTo}`;chips.push(`<span class="filter-chip">Fecha: ${ftxt}<button onclick="clearFilter('date')">x</button></span>`)}const inner=chips.length?chips.join(""):`<span class="sub">Ninguno</span>`;document.getElementById("activeFilters").innerHTML=`<span style="font-size:10px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.04em;margin-right:6px">Filtros activos:</span>${inner}`}
function renderQuickStatus(){const chips=statuses.map(s=>{const color=s==="Reunión futura"?"blue":s==="Reunión realizada"?"green":s==="Reunión cancelada"?"red":"orange";return [s,"status",s,color]});const el=document.getElementById("quickStatus");if(!el)return;el.innerHTML=chips.map(c=>`<button class="qd-chip ${c[3]} ${filters[c[1]]===c[2]?"on":""}" onclick="toggleFilter('${c[1]}','${c[2]}');render()">${c[0]}</button>`).join("")}
function renderKpis(rows){const total=rows.length||1;const cards=[["Total reuniones",rows.length,"Todas las reuniones","blue","T",()=>{filters.status="Todos";filters.cp="Todos";filters.clientVal="Todos";filters.final="Todos"}],["Válidas",rows.filter(x=>finalStatus(x)==="Reunión válida").length,pct(rows.filter(x=>finalStatus(x)==="Reunión válida").length,total),"green","V",()=>toggleFilter("final","Reunión válida")],["No válidas",rows.filter(x=>finalStatus(x)==="Reunión no válida").length,pct(rows.filter(x=>finalStatus(x)==="Reunión no válida").length,total),"red","X",()=>toggleFilter("final","Reunión no válida")],["Pendiente CP",rows.filter(x=>x.cp==="Pendiente").length,pct(rows.filter(x=>x.cp==="Pendiente").length,total),"orange","P",()=>toggleFilter("cp","Pendiente")],["Pendiente cliente",rows.filter(x=>x.clientVal==="Pendiente").length,pct(rows.filter(x=>x.clientVal==="Pendiente").length,total),"orange","PC",()=>toggleFilter("clientVal","Pendiente")]];window.__kpiActions=cards.map(c=>c[5]);document.getElementById("kpis").innerHTML=cards.map((i,idx)=>`<div class="kpi ${kpiActive(i[0])?"active":""}" onclick="__kpiActions[${idx}]();render()"><div class="ico ${i[3]}">${i[4]}</div><div><span>${i[0]}</span><b>${i[1]}</b><small>${i[2]}</small></div></div>`).join("")}
function kpiActive(label){return label==="Válidas"&&filters.final==="Reunión válida"||label==="No válidas"&&filters.final==="Reunión no válida"||label==="Pendiente CP"&&filters.cp==="Pendiente"||label==="Pendiente cliente"&&filters.clientVal==="Pendiente"}
...
function render(){const rows=applyFilters();document.body.classList.toggle("detail-open",panelOpen);document.getElementById("layout").classList.toggle("open",panelOpen);document.getElementById("drawer").classList.toggle("hidden",!panelOpen);renderFilters(rows);renderQuickStatus();renderKpis(rows);renderProgress(rows);renderHead();renderRows(rows);renderNotifications();if(panelOpen)renderPanel();scheduleComponentHeight()}
