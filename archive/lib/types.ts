...
export type MeetingFlowStatus =
  | "future_meeting"
  | "cancelled_meeting"
  | "pending_cp_evaluation"
  | "pending_client_evaluation"
  | "client_requests_review"
  | "evaluation_closed_valid"
  | "evaluation_closed_not_valid";

export const meetingFlowStatusLabels: Record<MeetingFlowStatus, string> = {
  future_meeting: "Reunión futura",
  cancelled_meeting: "Reunión cancelada",
  pending_cp_evaluation: "Pendiente de evaluación CP",
  pending_client_evaluation: "Pendiente de evaluación cliente",
  client_requests_review: "Cliente solicita revisión",
  evaluation_closed_valid: "Evaluación cerrada · Válida",
  evaluation_closed_not_valid: "Evaluación cerrada · No válida",
};
